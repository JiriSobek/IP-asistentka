...
Pasivní věty převeď na aktivní, aby bylo vždy jasné, kdo co dělá.
...
V závěru, úplně na konci odpovědi a vždy v novém odstavci odděleném prázdným řádkem, krátce okomentuj provedené změny, proč je to takto lepší. Zdůrazni: je to jen návrh a je na tobě, co z navržených změn použiješ.
